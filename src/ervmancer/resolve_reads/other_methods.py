...
def assign_tree_for_other_methods(path_to_other_csv: str, path_for_output_csv: str, clade_under_dict: dict, herv_path_dict: dict):
    ...
    # next, give information to the end user if their csv differs from the test csv
    ...
    if hervs_not_present:
        logging.info('These HERVs in the leaves of the tree were not present in your CSV: \n' +
              str(hervs_not_present) + '\n')
    else:
        logging.info('All HERVs at the leaves of the tree are present in the columns of your CSV')
    ...
    if columns_not_hervs:
        logging.info('These columns of your CSV were not present in the list of HERVs at the leaves of the tree: \n' +
              str(columns_not_hervs) + '\n')
    else:
        logging.info('No additional non-HERV columns found')
